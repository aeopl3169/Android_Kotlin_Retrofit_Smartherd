package com.shiva.retrofitputupdatetoserverkotlin5_3.activities
...
import com.shiva.retrofitputupdatetoserverkotlin5_3.services.DestinationService
import com.shiva.retrofitputupdatetoserverkotlin5_3.services.ServiceBuilder
import com.shiva.retrofitputupdatetoserverkotlin5_3.R
import com.shiva.retrofitputupdatetoserverkotlin5_3.models.Destination
...
class DestinationDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle?.containsKey(ARG_ITEM_ID)!!) {
            Log.i("Shiva","bundle?.containsKey(ARG_ITEM_ID) : "+bundle?.containsKey(ARG_ITEM_ID))
    ...
    private fun initUpdateButton(id: Int) {
        ...
        btn_update.setOnClickListener {
            ...
            val destinationService = ServiceBuilder.buildService(DestinationService::class.java)
            // Updating destination using FormURLEncoded format
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            if (android.os.Build.VERSION.SDK_INT <= android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH){
                ...
                NavUtils.navigateUpTo(this, Intent(this, DestinationListActivity::class.java))
            }
            return true
        }
